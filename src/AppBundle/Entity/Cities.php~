 ...
 * Cities
 *
 * @ORM\Table(name="Cities", uniqueConstraints={@ORM\UniqueConstraint(name="Cities_Name_CountriesU", columns={"Name", "ID_COUNTRIES"})}, indexes={@ORM\Index(name="Cities_ID_COUNTRIES_FK", columns={"ID_COUNTRIES"})})
 * @ORM\Entity
 */
class Cities
{
