 ...
 * Invoices
 *
 * @ORM\Table(name="Invoices", uniqueConstraints={@ORM\UniqueConstraint(name="Invoices_NameU", columns={"Name"})}, indexes={@ORM\Index(name="Invoices_ID_CUSTOMERS_FK", columns={"ID_CUSTOMERS"}), @ORM\Index(name="Invoices_ID_USERS_FK", columns={"ID_USERS"})})
 * @ORM\Entity
 */
class Invoices
{
