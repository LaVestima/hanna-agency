...
CREATE TABLE IF NOT EXISTS Categories (
	...
	CONSTRAINT Categories_ID_Parent_FK FOREIGN KEY (ID_PARENT) REFERENCES Categories(ID)
);
...
CREATE TABLE IF NOT EXISTS Companies (
	...
	CONSTRAINT Companies_Path_Slug_U UNIQUE(Path_Slug),
	CONSTRAINT Companies_ID_COUNTRIES_FK FOREIGN KEY (ID_COUNTRIES) REFERENCES Countries(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT Companies_ID_CITIES_FK FOREIGN KEY (ID_CITIES) REFERENCES Cities(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT Companies_ID_USERS_FK FOREIGN KEY (ID_USERS) REFERENCES Users(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Products (
	...
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT Items_ID_COMPANIES_FK FOREIGN KEY (ID_COMPANIES) REFERENCES Companies(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Shipment_Options (
  ...
  CONSTRAINT Shipment_Options_PK PRIMARY KEY (ID),
	CONSTRAINT Shipment_Options_Name_U UNIQUE(Name)
);

CREATE TABLE IF NOT EXISTS Products_Shipment_Options (
  ID INTEGER NOT NULL AUTO_INCREMENT,
	ID_PRODUCTS INTEGER NOT NULL,
	ID_SHIPMENT_OPTIONS INTEGER NOT NULL,
	Cost DECIMAL(10, 2) NOT NULL,
	CONSTRAINT Products_Shipment_Options_PK PRIMARY KEY (ID),
	CONSTRAINT Products_Shipment_Options_ID_PRODUCTS_FK FOREIGN KEY (ID_PRODUCTS) REFERENCES Products(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT Products_Shipment_Options_ID_SHIPMENT_OPTIONS_FK FOREIGN KEY (ID_SHIPMENT_OPTIONS) REFERENCES Shipment_Options(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
INSERT INTO Shipment_Options (ID, Name, Cost) VALUES (3, 'GLS', 2.50);
