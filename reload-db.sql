...
DROP TABLE IF EXISTS History_Invoices;
DROP TABLE IF EXISTS Invoices;
DROP TABLE IF EXISTS Producers;
DROP TABLE IF EXISTS History_Customers; -- 13
...
DROP TABLE IF EXISTS Currencies; -- 24
...
CREATE TABLE IF NOT EXISTS History_Users (
	...
	ID_ROLES INTEGER,
	CONSTRAINT History_Users_PK PRIMARY KEY (ID),
	CONSTRAINT History_Users_ID_USERS_FK FOREIGN KEY (ID_USERS) REFERENCES Users(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Users_ID_ROLES_FK FOREIGN KEY (ID_ROLES) REFERENCES Roles(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS History_Customers (
	...
	Email VARCHAR(200),
	Phone VARCHAR(50),
	ID_CURRENCIES INTEGER,
	Default_Discount INTEGER DEFAULT 0,
	ID_USERS INTEGER,
	CONSTRAINT History_Customers_PK PRIMARY KEY (ID),
	CONSTRAINT History_Customers_Gender_CH CHECK (Gender='M' OR Gender='F' OR Gender='O'),
	CONSTRAINT History_Customers_ID_CUSTOMERS_FK FOREIGN KEY (ID_CUSTOMERS) REFERENCES Customers(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Customers_ID_COUNTRIES_FK FOREIGN KEY (ID_COUNTRIES) REFERENCES Countries(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Customers_ID_CITIES_FK FOREIGN KEY (ID_CITIES) REFERENCES Cities(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Customers_ID_CURRENCIES_FK FOREIGN KEY (ID_CURRENCIES) REFERENCES Currencies(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Customers_ID_USERS_FK FOREIGN KEY (ID_USERS) REFERENCES Users(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS History_Orders (
	...
	CONSTRAINT History_Orders_PK PRIMARY KEY (ID),
	CONSTRAINT History_Orders_ID_ORDERS_FK FOREIGN KEY (ID_ORDERS) REFERENCES Orders(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Orders_User_Edited_FK FOREIGN KEY (User_Edited) REFERENCES Users(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Orders_ID_CUSTOMERS_FK FOREIGN KEY (ID_CUSTOMERS) REFERENCES Customers(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Invoices (
	...
	CONSTRAINT Invoices_ID_CUSTOMERS_FK FOREIGN KEY (ID_CUSTOMERS) REFERENCES Customers(ID)
		ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT Invoices_ID_ORDERS_FK FOREIGN KEY (ID_ORDERS) REFERENCES Orders(ID)
		ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS History_Invoices (
	ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS History_Products (
	...
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Items_ID_CATEGORIES_FK FOREIGN KEY (ID_CATEGORIES) REFERENCES Categories(ID)
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT History_Items_ID_PRODUCERS_FK FOREIGN KEY (ID_PRODUCERS) REFERENCES Producers(ID)
	ON UPDATE CASCADE ON DELETE CASCADE
);
...
INSERT INTO Orders (ID, ID_CUSTOMERS, User_Created, Path_Slug) VALUES (2, 1, 5, 'ZZgtZjORKCCKKTflMgLr7UpKpC2ErHGE2LqW6tMASMylmPKlBP');
INSERT INTO Orders (ID, ID_CUSTOMERS, User_Created, Path_Slug) VALUES (3, 4, 4, 'DgUqtlNvIMx2uzQz5iqU5perhrHME8tUkVR9aGT095W0rWCk7U');
INSERT INTO Orders (ID, ID_CUSTOMERS, User_Created, Path_Slug) VALUES (4, 2, 1, 'g11SxwcyZw9ILjAiCi0eVjF6BT8cy5BixERUR0Lm79cGQFTGwJ');

INSERT INTO Invoices (ID, Name, ID_CUSTOMERS, ID_ORDERS, User_Created, Date_Issued, Path_Slug) VALUES (1, '1/2016', 2, 1, 1, '2016-02-26', 'fQ5oxD0fkgVdl9NZp6QbO9aDhF4wqbY9FqKfpVckiCOsdk6vpG');
INSERT INTO Invoices (ID, Name, ID_CUSTOMERS, ID_ORDERS, User_Created, Date_Issued, Path_Slug) VALUES (2, '4/2017', 4, 2, 2, '2017-03-01', 'iqHtsskeLDHD5LtJBfFBzPNB5AWGSrr16IGhCrZA2AtcOH1tFT');
...
INSERT INTO Invoices (ID, Name, ID_CUSTOMERS, ID_ORDERS, User_Created, Date_Issued, Path_Slug) VALUES (4, '16/2015', 1, 3, 2, '2015-10-15', 'rsooOH9b8LZW8A4c6kb0wDjhpqonhCNWcXo9AgZuHI8HrEV4q0');
INSERT INTO Invoices (ID, Name, ID_CUSTOMERS, ID_ORDERS, User_Created, Date_Issued, Path_Slug) VALUES (5, '10/2014', 2, 4, 2, '2014-11-01', 'sNQT0j1GFoMrQ8UieAPb7UKAVLg9ID02z07rC13AOdustnEgBe');
